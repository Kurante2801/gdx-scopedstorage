...
// Package MUST be com.badlogic.gdx.backends.android since it has some private functions we need to use
// Literally the only change in this file is making it extend from ComponentActivity
